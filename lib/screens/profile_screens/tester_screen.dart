...
class _GamesForSaleScreenState extends State<GamesForSaleScreen> {
  List<int> list = List.filled(25 , 3);
  List<int> list2 =  List.filled(25 , 2);
  ...
  _scrollListener() {
    setState(() {
      ...
      _createSaleContainerColor = Color.lerp(BACKGROUND_COLOR, FILL_COLOR, _t)!;
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        decoration:
                                        BoxDecoration(borderRadius: BorderRadius.circular(50), color: FILL_COLOR),
              ...
              //             price: "4000",
              //             soldTo: "Jake",
              //             backgroundImage: "assets/images/cyberpunk.jpg",
              //           );
              //         }).toList()),
              //   ),
              // )
