...
import '../../../../view_models/onboarding/setup_sales_account_view_model/sales-account-model.dart';
import '../../../../widgets/custom_body.dart';
import '../../../../widgets/custom_button_widget.dart';
import '../../../../widgets/custom_text_widget.dart';
import '../../../../widgets/custom_textfield_widget.dart';
import '../../../../widgets/game_picker_widget.dart';
      ...
      floatingActionButton: GestureDetector(
          ...
          child: Container(
              ...
              child: CustomButton(
                  ...
                  buttonText: 'GAME ON!',
                  onPressed: () => Provider.of<SetupSalesViewModel>(context, listen: false)
                      .performAPIRequest()))),
      body: CustomBody(
        ...
        body: [
          Container(
            margin: EdgeInsets.only(
                left: ScreenUtils.getDesignHeight(24), right: ScreenUtils.getDesignHeight(24)),
            child: Column(
              children: [
                Container(
                  child: Column(
                      ...
                      Container(
                          ...
                          child: CustomTextWidget(
                            ...
                            style: Theme.of(context).primaryTextTheme.headline4?.copyWith(
                                fontFamily: CircularBook, color: Colors.white.withOpacity(0.6)),
                          )),
                    ],
                  ),
                ),
          ...
          Container(
            margin: EdgeInsets.only(
                ...
                left: ScreenUtils.getDesignHeight(24),
                right: ScreenUtils.getDesignHeight(24)),
            child: Row(
              children: [
                CustomTextWidget(
          ...
          ChangeNotifierProvider.value(
            ...
            child: CustomGamePicker(
              gameType: SearchType.SETUP_SALES,
            ),
          ),
          Container(
            margin: EdgeInsets.only(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextfieldWidget(
                  ...
                  onChanged: (val) =>
                      Provider.of<SetupSalesViewModel>(context, listen: false).addPhoneNumber(val),
                ),
                Container(
                ...
                CustomTextfieldWidget(
                  ...
                  onChanged: (val) =>
                      Provider.of<SetupSalesViewModel>(context, listen: false).addDisplayName(val),
                ),
                Container(
                    margin: EdgeInsets.only(top: ScreenUtils.getDesignHeight(30)),
                    child: CustomTextWidget(
                  ...
                  child: Row(
                    children: [
                      ...
                      Consumer<SetupSalesViewModel>(
                        builder: (_, value, __) {
                          return Container(
                            ...
                            child: value.selectedAddress.isEmpty
                                ? CustomTextWidget(
                      ...
                      GestureDetector(
                        onTap: () async {
                          dynamic location =
                              await Navigator.pushNamed(context, CUSTOM_ADDRESS_SEARCH_SCREEN);
                          Provider.of<SetupSalesViewModel>(context, listen: false)
                              .addLocation(location as LocationModel);
                        },
                        child: Container(
                          ...
                          child: Consumer<SetupSalesViewModel>(
                            builder: (_, value, __) {
                              return Center(
                                child: CustomTextWidget(
                                  value.selectedAddress.isEmpty ? 'Add Here' : 'Change Now',
                                  isDynamic: false,
