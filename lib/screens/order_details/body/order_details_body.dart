...
class OrderListBody extends StatefulWidget {
  ...
  OrderListBody({this.salesPayload});
      ...
      child: Column(
        ...
        children: [
          ...
          _labelWidget(
            ...
            value1: widget.salesPayload!.seller!.displayName ?? 'Did not load',
            label2: "Contact No.",
            value2: widget.salesPayload!.seller!.phoneNumber ?? 'Did not load',
          ),
          _divider(),
          _labelWidget(
            label1: "Order Status",
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: Text(
                      widget.salesPayload!.seller!.address ?? 'Not Mentioned',
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(widget.salesPayload!.seller!.displayName ?? 'Not Mentioned', style: Theme.of(context).primaryTextTheme.headline4),
                  SizedBox(
                    height: 5.0,
                  ),
                  Row(
