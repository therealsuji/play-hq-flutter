...
class _GameListScreenState extends State<GameListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        margin: EdgeInsets.only(left: ScreenUtils.getDesignWidth(24.0) , right: ScreenUtils.getDesignWidth(24.0) , top: ScreenUtils.getDesignHeight(60.0)),
        child: Column(
          children: [
            Row(
              children: [
              ...
              builder: (_ , val , __){
                return val.gameResponse.isNotEmpty ? Expanded(
                  child: Container(
                    margin: EdgeInsets.only(top: ScreenUtils.getDesignHeight(20.0) , bottom: ScreenUtils.getDesignHeight(20.0)),
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () => locator<NavigationService>().pushNamed(GAME_DETAILS_SCREEN , args: GameDetailsArguments(gameId: val.gameResponse[index].id)),
                          child: GameListItem(
