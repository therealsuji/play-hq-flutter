...
const List<Map<String, dynamic>> discoverComponents = [
  {
    ...
    'gradient': GRADIENT_COMPONENT_1,
    'imagePath': 'assets/images/discovery_category_1.png',
    'category': DiscoverCategory.TOP_RATED_GAMES,
    'apiType': GameLists.TOP_RATED_GAMES
  },
  {
    'name': 'Most Anticipated Games',
    'gradient': GRADIENT_COMPONENT_2,
    'imagePath': 'assets/images/discovery_category_2.png',
    'category': DiscoverCategory.MOST_ANTICIPATED_GAMES,
    'apiType': GameLists.MOST_ANTICIPATED_GAMES
  },
  {
    'name': 'Games of 2023',
    'gradient': GRADIENT_COMPONENT_3,
    'imagePath': 'assets/images/discovery_category_3.png',
    'category': DiscoverCategory.GAMES_OF_2022,
    'apiType': GameLists.GAMES_OF_2022
  },
];

const List<Map<String, dynamic>> onboardingData = [
  {
    'image': 'assets/images/home_onboarding.png',
    'title': 'Best Deals in the Market',
    'description':
        'Your favourite games given to you write at your\nfingertips for awesome prices. These games are\nshown to you according to your gamer preferance!'
  },
  {
    'image': 'assets/images/discover_onboarding.png',
    'title': 'Latest & Greatest Games',
    'description':
        'Go through a game database of more than 3000\ngames and stay upto date on the latest and\ntrending games in the world.'
  },
  {
    'image': 'assets/images/sales_onboarding.png',
    'title': 'Sell any Game Easy',
    'description':
        'Want to sell a game you aren’t playing anymore?\nWe got you covered! Sell any console game you\nwant in a jiffy!'
  },
  {
    'image': 'assets/images/sales_onboarding.png',
    'title': 'Track your Order',
    'description':
        'Whether you’re selling or buying a game, we’ve got\nyou covered from the start to finish of the order.\nTrack your order easy peasy.'
  }
];
...
const List<Map<String, dynamic>> testingCarousalData = [
  ...
  {
    'image': 'https://image.api.playstation.com/vulcan/ap/rnd/202208/0921/3XopdGAJGRy3xNQKnQDvaCRs.png',
    'title': 'Hogwarts Legacy',
    'genres': 'Action/RPG'
  },
  {
    'image':
        'https://store-images.s-microsoft.com/image/apps.7076.14541540923841523.c79d523a-7cfd-4ca7-9bd1-ecf63049e304.e187008e-9ba6-4b5b-84cf-105f5df62c0e?mode=scale&q=90&h=1080&w=1920',
    'title': 'Forspoken',
    'genres': 'Action/Horror'
  },
  {
    'image': 'https://assets-prd.ignimgs.com/2022/12/01/callistoprotocol-blogroll-1669873578077.jpg',
...
const List<Map<String, dynamic>> genreList = [
  ...
  },
  {
    "id": 11,
    "name": "Arcade",
    "image_background": "https://media.rawg.io/media/screenshots/d93/d93e93149d781484bfc9c6ae7b48e1d4.jpg",
  },
  {
    "id": 83,
    "name": "Platformer",
  ...
  },
  {
    "id": 6,
    "name": "Fighting",
    "image_background": "https://media.rawg.io/media/screenshots/887/8879d408311d7614162987cc7fbd3750.jpg",
  },
  {
    "id": 28,
    "name": "Board Games",
